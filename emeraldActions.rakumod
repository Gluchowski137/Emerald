...
class EmeraldActions {
    has EmeraldEvaluator $.evaluator;
    ...
    multi method value($/ where $<function-call>) {
        $/.make(AST::FunctionCall.new(
                function-name => ~$<function-call><function-name>,
                argument => $<function-call><value>.made,
                ));
    }
